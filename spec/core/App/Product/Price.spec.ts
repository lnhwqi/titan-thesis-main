import { createPrice, createPriceE } from "../../../../Core/App/Product/Price"
import { _fromErr } from "../../../Fixture/Result"

describe("App/Product/Price", () => {
  it("valid price", () => {
  ...
  it("createPriceE returns error for exceeding MAX_INT_32", () => {
    assert.strictEqual(_fromErr(createPriceE(2147483648)), "INVALID_PRICE")
  })
})
