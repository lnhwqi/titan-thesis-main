...
const styles = {
  page: css({
    minHeight: "100dvh",
    padding: theme.s6,
    background: `radial-gradient(circle at 10% 15%, rgba(0, 82, 156, 0.08) 0%, transparent 40%), radial-gradient(circle at 90% 10%, rgba(237, 28, 36, 0.05) 0%, transparent 35%), ${color.secondary10}`,
    ...bp.md({
  ...
  hero: css({
    ...
    padding: theme.s6,
    boxShadow:
      "0 16px 36px rgba(0, 82, 156, 0.24), 0 0 0 1px rgba(255, 255, 255, 0.08)",
    ...
    "&::before": {
      ...
      inset: 0,
      background:
        "radial-gradient(circle at 75% 25%, rgba(255, 255, 255, 0.14) 0%, transparent 50%), radial-gradient(circle at 20% 80%, rgba(241, 248, 255, 0.18) 0%, transparent 40%)",
      pointerEvents: "none",
    },
    "&::after": {
      content: '""',
  ...
  heroSecondaryButton: css({
    ...
    "&:hover": {
      ...
      boxShadow: "0 4px 16px rgba(0, 82, 156, 0.24)",
    },
  }),
  ...
  tierPill: css({
    ...
    background: `linear-gradient(135deg, ${color.secondary500}, ${color.primary500})`,
    color: color.neutral0,
    ...font.bold12,
    textTransform: "uppercase",
    letterSpacing: "0.08em",
  ...
  gateContainer: css({
    ...
    justifyContent: "center",
    alignItems: "center",
    background: `linear-gradient(-45deg, ${color.secondary500}, ${color.secondary400}, ${color.primary400}, ${color.secondary500})`,
